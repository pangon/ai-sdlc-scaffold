...
3. **Start with objectives**: Define what you're building in `01-objectives/`
4. **Design the system**: Document architecture and decisions in `02-design/`
5. **Build it**: Implement and track tasks in `03-code/`
6. **Ship it**: Deploy and operate from `04-deploy/`
...
- **Architecture Decisions (ADRs)** in `02-design/decisions/`: High-level technology and design choices (e.g., "use PostgreSQL", "adopt microservices")
- **Development Decisions (DECs)** in `03-code/decisions/`: Implementation patterns that code must follow (e.g., "all delete operations cascade", "errors use structured format")
...
The `.claude/skills/next-task/` skill enables Claude Code to automatically pick and execute the next pending task from `03-code/tasks.md`. It handles complexity assessment, decision checking, and contract verification.
...
- [ ] Fill in `01-objectives/goals.md` with your project goals
- [ ] Fill in `01-objectives/requirements.md` with your requirements
- [ ] Fill in `01-objectives/constraints.md` with your constraints
- [ ] Customize `03-code/CLAUDE.code.md` directory structure and build commands
- [ ] Customize `03-code/tasks.md` with your initial task breakdown
