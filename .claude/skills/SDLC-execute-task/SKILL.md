...
Read and follow the shared procedure in [`shared/constraint-tension-check.md`](../shared/constraint-tension-check.md). If no tensions are found, proceed to step 6.

#### 6. Evaluate Development Environment Needs

Read and follow the shared procedure in [`shared/dev-environment-evaluation.md`](../shared/dev-environment-evaluation.md).
...
Read and follow the shared rules in [`shared/implementation-log-rules.md`](../shared/implementation-log-rules.md); the task-specific rules below define location, naming, and log-file setup.
...
Read and follow the shared procedure in [`shared/design-gap-procedure.md`](../shared/design-gap-procedure.md).
