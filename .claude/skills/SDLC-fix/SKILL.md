...
Read and follow the shared procedure in [`shared/constraint-tension-check.md`](../shared/constraint-tension-check.md). If no tensions are found, proceed to step 7.
...
Read and follow the shared rules in [`shared/implementation-log-rules.md`](../shared/implementation-log-rules.md); the fix-specific rules below define location, naming, and log-file setup.
